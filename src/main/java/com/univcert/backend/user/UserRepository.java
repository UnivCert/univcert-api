...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query(value = "select u from User u left join fetch u.certList where u.API_KEY = :API_KEY ")
    Optional<User> findByAPI_KEYFetchCertList(@Param("API_KEY")String API_KEY);
